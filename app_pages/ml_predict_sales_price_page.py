...
def ml_predict_sales_price_page_body():
    ...
    st.info(
        ...
        f"Where the max_depth = 32 n_estimators = 150. With these hyperparameters set within the model "
        f"we ran a custum function to determine the features of importance.\n"
    ...
    st.info(
        ...
        f" They refer to the train set and test set respectivly, again if you wish to view the process that lead to these results, "
